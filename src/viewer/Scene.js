...
export class Scene extends EventDispatcher {
  ...
  initialize() {
...

    {
      ...
      let texture = Utils.linearGradientBackgroundTexture(512, 512);

      texture.minFilter = texture.magFilter = THREE.LinearFilter; // Set filter types
    ...
    // {
    //   // background - potree - old gradient
